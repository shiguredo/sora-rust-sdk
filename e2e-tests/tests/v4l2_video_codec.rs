...
async fn test_v4l2_sendonly_recvonly() {
    ...
    let sendonly_context =
        create_v4l2_context().expect("sendonly のコンテキスト生成に失敗しました");
    ...
    let recvonly_context =
        create_v4l2_context().expect("recvonly のコンテキスト生成に失敗しました");
...
async fn test_v4l2_sendrecv() {
    ...
    let context1 = create_v4l2_context().expect("client1 のコンテキスト生成に失敗しました");
    ...
    let context2 = create_v4l2_context().expect("client2 のコンテキスト生成に失敗しました");
